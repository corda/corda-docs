...
* [Auth Service](../../corda-enterprise/4.7/node/auth-service.md) The user authentication and authorization service for CENM. Stores and controls secure user-access to network services.
