...
1. Generate new certificates for [FARM](../../corda-enterprise/4.8/node/gateway-service.md), [Auth](../../corda-enterprise/4.8/node/auth-service.md), and [Zone](zone-service.md) Services.
...
To generate the JWT, refer to the [Auth Service](../../corda-enterprise/4.8/node/auth-service.md) documentation.
...
* [FARM Service](../../corda-enterprise/4.8/node/gateway-service.md)
...
The [Auth Service](../../corda-enterprise/4.8/node/auth-service.md) has an initial user who can manage users, however
