...
Identity Manager, Network Map and Zone Service requires database migration.
...
of permissions and predefined roles. Copy this into a folder inside the working directory called `plugins`.
