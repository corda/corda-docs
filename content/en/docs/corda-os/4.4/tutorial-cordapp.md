...
```bash
curl -i -X POST 'http://localhost:50005/api/example/create-iou?iouValue=12&partyName=O=PartyB,L=Paris,C=FR' -H 'Content-Type: application/x-www-form-urlencoded'
```
