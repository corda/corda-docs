...
```
[PersistentTypes.kt](https://github.com/corda/enterprise/blob/release/ent/3.1/core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt)
...
```
[SchemaService.kt](https://github.com/corda/enterprise/blob/release/ent/3.1/node/src/main/kotlin/net/corda/node/services/api/SchemaService.kt)
```kotlin
/**
...
```
[HibernateConfigurationTest.kt](https://github.com/corda/enterprise/blob/release/ent/3.1/node/src/test/kotlin/net/corda/node/services/persistence/HibernateConfigurationTest.kt)
...
```
[CustomVaultQuery.kt](https://github.com/corda/enterprise/blob/release/ent/3.1/docs/source/example-code/src/main/kotlin/net/corda/docs/CustomVaultQuery.kt)
