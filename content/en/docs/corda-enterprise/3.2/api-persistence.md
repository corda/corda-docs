...
```
[PersistentTypes.kt](https://github.com/corda/enterprise/blob/release/ent/3.2/core/src/main/kotlin/net/corda/core/schemas/PersistentTypes.kt)
...
```
[SchemaService.kt](https://github.com/corda/enterprise/blob/release/ent/3.2/node/src/main/kotlin/net/corda/node/services/api/SchemaService.kt)
```kotlin
/**
...
```
[HibernateConfigurationTest.kt](https://github.com/corda/enterprise/blob/release/ent/3.2/node/src/test/kotlin/net/corda/node/services/persistence/HibernateConfigurationTest.kt)
...
```
[CustomVaultQuery.kt](https://github.com/corda/enterprise/blob/release/ent/3.2/docs/source/example-code/src/main/kotlin/net/corda/docs/CustomVaultQuery.kt)
