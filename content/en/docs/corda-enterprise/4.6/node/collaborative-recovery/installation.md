...
* [**LedgerGraph** CorDapp](./../operating/ledger-graph). The collaborative recovery CorDapps depend on the LedgerGraph CorDapp with a version matching that of the Collaborative Recovery CorDapps.
