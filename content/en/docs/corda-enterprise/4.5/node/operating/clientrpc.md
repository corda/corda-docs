...
`@CordaSerializable` annotation (see [Serialization](../../serialization-index.md)). An example is shown in [Using the client RPC API](../../../../corda-os/4.5/tutorial-clientrpc-api.md).
